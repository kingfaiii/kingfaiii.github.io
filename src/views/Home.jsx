  ...
  return (
    <div className="md:flex block md:h-90vh justify-center flex-wrap items-center mt-11 md:mt-auto md:max-w-7xl w-full m-auto md:px-11 px-4">
      <div className="md:w-1/2">
        ...
        <p className="text-white opacity-70 text-sm mb-7 leading-6">As a Front-End Developer, I bring a diverse set of skills to the table, ensuring that every project I undertake is executed with precision and creativity. My proficiency extends across various technologies and methodologies, making me a versatile and effective developer.</p>
        <Button link={CV} content="Download CV" />
      </div>
      <div className="md:w-1/2 container-glow flex md:justify-end justify-center">
