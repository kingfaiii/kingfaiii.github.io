const About = () => {
  return (
    <div className="mt-[200px] max-w-7xl m-auto px-11 flex flex-col justify-center">
      <h1 className="text-9xl text-white">About.</h1>
      <div className="ms-12 text-white mt-10">
        <p className="font-bold text-2xl leading-[110%]">Welcome to my corner of digital universe! I&apos;m King, a passionate Front End Developer with keen eye for creating visually appealing and user-friendly websites.</p>
      </div>
      <div className="flex mt-14 gap-16 text-white leading-[1.75rem]">
        <div className="w-[35%]">
        ...
        <p className="font-bold text-xl mb-2">Philosophy</p>
          ...
          <p className="mb-6">
            When I&apos;m not at the computer, I&apos;m usually taking some rest, planning what will be my next step on my life, hanging out with my Girlfriend or Visiting my siblings on my grandparents.
          </p>
        </div>
      </div>
    </div>
